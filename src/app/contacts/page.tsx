      ...
      <section className="bg-gradient-to-br from-fiitsa-light via-white to-fiitsa-light py-20">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto max-w-3xl text-lg text-gray-600 md:text-xl">
            {language === "fr"
              ? "Notre équipe est la pour vous accompagner. Choisissez le canal qui vous convient le mieux."
            ...
            <Card className="shadow-lg">
              ...
              <CardContent className="space-y-6">
                <form className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="phone">{language === "fr" ? "Telephone (optionnel)" : "Phone (optional)"}</Label>
