...
const translations = {
  fr: {
    ...
    hero: {
      ...
      templateNote:
        "Ces tarifs s'appliquent aux messages templates uniquement. Les réponses libres dans la fenêtre 24h sont GRATUITES.",
    },
    importantBanner: {
      title: "Important à savoir",
      text: "Seuls les messages templates (modèles pré-approuvés par WhatsApp) sont facturés. Quand un client t'écrit, tu as 24h pour lui répondre librement (free-form) sans frais.",
    },
    types: {
      title: "Les 4 types de templates WhatsApp",
      subtitle: "Seuls les templates sont payants - les réponses libres dans la fenêtre 24h sont gratuites",
      marketing: {
        name: "Marketing",
      ...
      utility: {
        name: "Utilitaire",
        description: "Confirmations de commande, suivi de livraison, mises ? jour",
        rate: "$0.0040",
        rateFCFA: "2.4 FCFA",
      ...
      service: {
        ...
        rate: "Gratuit",
        rateFCFA: "0 FCFA",
        note: "Uniquement dans la fenêtre 24h",
      },
    },
    howItWorks: {
      ...
      rule1: {
        ...
        description:
          "Quand un client t'envoie un message, une fenêtre de 24h s'ouvre. Pendant ce temps, tu peux lui répondre avec des messages utilitaires ou libres GRATUITEMENT.",
      },
      rule2: {
        title: "La fenêtre 72h (Free Entry Point)",
        description:
      ...
      rule3: {
        ...
        description:
          "Pour écrire a quelqu'un EN PREMIER (hors fenêtre), tu dois utiliser un template pré-approuvé. Les tarifs que tu vois ici concernent UNIQUEMENT ces templates. Les messages free-form dans la fenêtre 24h = 0 FCFA.",
      },
    },
    pricing: {
    ...
    examples: {
      ...
      example1: {
        title: "Campagne promo a 1 000 clients",
      ...
      example2: {
        ...
        description: "Tes clients ont pass? commande sur ton site",
        calculation: "Si clients ?crivent d'abord -> GRATUIT",
      ...
      example4: {
        ...
        description: "Repondre aux questions des clients",
        calculation: "Client écrit -> tu réponds = GRATUIT",
        result: "0 FCFA",
      },
    },
    tips: {
      title: "Astuces pour économiser",
      subtitle: "Optimise tes couts WhatsApp",
      tip1: {
        title: "Encourage les clients à t'écrire en premier",
        description:
          "Affiche ton WhatsApp partout (site, réseaux, emballages). Quand ils t'?crivent, les réponses utilitaires sont gratuites !",
      },
      tip2: {
        title: "Utilise les pubs Click-to-WhatsApp",
        description:
          "Les clients qui viennent de tes pubs Facebook/Instagram ouvrent une fenêtre 72h gratuite. Profites-en pour envoyer tous tes messages.",
      },
      tip3: {
        title: "Envoie les confirmations dans les 24h",
        description:
          "Si un client a pass? commande (et t'a écrit), envoie ta confirmation de commande dans les 24h pour qu'elle soit gratuite.",
      },
      tip4: {
      ...
      items: [
        {
          ...
          answer:
            "Non ! Seuls les messages templates (modèles pré-approuvés) sont facturés. Quand un client t'écrit, tu as 24h pour lui répondre avec des messages libres (free-form) GRATUITEMENT. Les tarifs affiches sur cette page concernent uniquement les templates.",
        },
        {
          question: "Qu'est-ce qu'un message template ?",
          answer:
            "Un template est un message pré-approuvé par WhatsApp que tu peux utiliser pour contacter quelqu'un EN PREMIER. C'est obligatoire pour initier une conversation ou envoyer des messages en dehors de la fenêtre de 24h. Tu créés le template, WhatsApp le valide, et tu peux l'utiliser. C'est la seule catégorie de message payante.",
        },
        {
          question: "Comment savoir si ma fenêtre de 24h est ouverte ?",
          answer:
            "La fenêtre s'ouvre quand le client t'envoie un message et reste ouverte pendant 24h. Dans l'API WhatsApp, tu reçois un webhook qui t'indique quand un message client arrive. Sur Fiitsa, on gère ça automatiquement pour toi.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Dans ton tableau de bord Fiitsa, va dans Paramêtres > Intégrations > WhatsApp. On te guide étape par étape pour connecter ton numéro WhatsApp Business. C'est simple et rapide !",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Les appels entrants (clients qui t'appellent) sont GRATUITS. Les appels sortants (tu appelles le client) sont facturés ? la minute selon des paliers de volume. Un appel ouvre ou rafraichit aussi la fenêtre de 24h pour les messages. Les tarifs pour l'Afrique commencent ? $0.0103/minute. Cette fonctionnalite est disponible depuis aout 2025.",
        },
      ],
    },
    cta: {
  ...
  en: {
    ...
    types: {
      title: "The 4 types of WhatsApp templates",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "The WhatsApp Business app (free) is for small volumes, managed manually. The WhatsApp Business API (paid) allows automation, high volumes, website intégration, chatbots, etc. Fiitsa uses the API to give you all these features.",
        },
        {
          question: "How to activate WhatsApp Business API on Fiitsa?",
          answer:
            "In your Fiitsa dashboard, go to Settings > Intégrations > WhatsApp. We guide you step by step to connect your WhatsApp Business number. It's simple and fast!",
        },
        {
          question: "Will prices increase?",
          answer:
            "Meta (WhatsApp's owner) can adjust rates 4 times a year (January 1, April, July, October) with at least 1 month notice. We'll keep you informéd of any changes.",
        },
        {
...
const callingTranslations = {
  fr: {
    ...
    outboundNote: "Tu appelles le client, facture ? la minute",
    ...
    windowNote: "Un appel (entrant ou sortant accepte) ouvre ou rafraichit aussi la fenêtre de 24h pour les messages.",
  },
  en: {
