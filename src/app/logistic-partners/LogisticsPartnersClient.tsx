...
export default function LogisticsPartnersClient() {
  ...
  const t = {
    ...
    subtitle: {
      fr: "Trouvez un transitaire Chineη'Afrique ou un partenaire local (livraison, stockage, closing)",
      en: "Find a Chinaη'Africa forwarder or local partner (delivery, warehousing, closing)",
    },
    comingSoon: {
