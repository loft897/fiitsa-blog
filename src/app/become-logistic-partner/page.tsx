...
export default function BecomeLogisticPartner() {
  ...
  const t = {
    ...
    benefitsList: {
      fr: [
        "Visibilite accrue aupres de milliers de vendeurs africains",
        "Plateforme de gestion des demandes de devis",
        "Systeme d'avis et de notation pour renforcer votre credibilite",
        "Support technique et commercial dedie",
