...
export default function BetaTestingPage() {
  useEffect(() => {
    document.title =
      "Programme Bêta-Testeurs Fiitsa - Rejoins l’élite des entrepreneurs africains";

    const descriptionContent =
      "Rejoins les 100 bêta-testeurs exclusifs de Fiitsa ! 0% de commission pendant 3 mois, accès premium aux fonctionnalités IA, WhatsApp Business et automatisations.";
    ...
    updateOG(
      "og:description",
      "Programme exclusif : 0% de commission pendant 3 mois, accès premium aux fonctionnalités IA et WhatsApp Business."
    );
    updateOG("og:type", "website");
    updateOG("og:url", "https://fiitsa.com/beta-testing-program");
    updateOG(
      "og:image",
      "https://api.fiitsa.com/storage/v1/object/public/fiitsa-files/Logo%20Fiitsa.png"
    );
    ...
    updateTwitter("twitter:title", "Programme Bêta-Testeurs Fiitsa - 100 places exclusives");
    updateTwitter(
      "twitter:description",
      "Rejoins l’élite des entrepreneurs africains avec 0% de commission pendant 3 mois !"
    );
    updateTwitter(
      "twitter:image",
      "https://api.fiitsa.com/storage/v1/object/public/fiitsa-files/Logo%20Fiitsa.png"
    ...
    const structuredData = {
      ...
      "@type": "WebPage",
      name: "Programme Bêta-Testeurs Fiitsa",
      description:
        "Programme exclusif de bêta-testing pour entrepreneurs africains avec 0% de commission pendant 3 mois",
      ...
      offers: {
        "@type": "Offer",
        name: "Programme Bêta-Testeurs",
        description: "Accès gratuit avec 0% de commission pendant 3 mois",
