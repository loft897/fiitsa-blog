...
export default function FeaturesPage() {
  ...
  const steps = [
    ...
    },
    {
      ...
      desc:
        language === "fr"
          ? "Produits physiques, numériques, services, formations - tout est prêt."
    ...
    },
    {
      ...
      desc:
        language === "fr"
          ? "Active les paiements et reçois tes fonds sous 48h."
        ...
        <section className="border-t bg-gradient-to-br from-fiitsa-light via-fiitsa-purple/5 to-fiitsa-gold/10">
          <div className="container mx-auto px-4 py-12 md:py-16">
            ...
            <div className="mt-8 text-center">
              <a href={registerUrl}>
                <Button size="lg" className="bg-fiitsa-gold font-bold text-fiitsa-dark shadow-xl hover:bg-fiitsa-gold/90">
                  {language === "fr" ? "DÉMARRER GRATUITEMENT" : "START FREE"}
                </Button>
              </a>
            </div>
          </div>
