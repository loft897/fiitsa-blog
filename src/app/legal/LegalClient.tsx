    ...
    <MarketingLayout>
      <div className="mx-auto max-w-4xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            <h2 className="mb-4 text-2xl font-semibold text-fiitsa-dark">Éditeur du site</h2>
            <ul className="list-none space-y-2 text-gray-600">
              ...
              <li>
                <strong>Téléphone (WhatsApp) :</strong> +33 7 63 47 79 07
              </li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-semibold text-fiitsa-dark">Hébergement</h2>
            <ul className="list-none space-y-2 text-gray-600">
              <li>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              d&apos;auteur. Toute reproduction, même partielle, est interdite sans autorisation préalable écrite de Fiitsa.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              et de suppression des données vous concernant. Pour exercer ce droit, contactez-nous à hello@fiitsa.com.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              Les présentes mentions légales sont soumises au droit américain.
            </p>
          </section>
        </div>
      </div>
