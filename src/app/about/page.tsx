...
export default function AboutPage() {
  ...
  const values = [
    ...
    },
    {
      ...
      description:
        language === "fr"
          ? "Nous rendons la technologie accessible a tous, sans compromis sur la puissance."
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  {language === "fr"
                    ? "En 2024, nous avons observé un problème récurrent : les entrepreneurs africains utilisaient des plateformes qui ne comprenaient pas leurs besoins. Commissions exorbitantes, absence de Mobile Money, support inexistant, recours à plusieurs plateformes pour la gestion de leur business..."
      ...
      <section className="bg-fiitsa-dark py-20 text-white">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mb-8 text-lg text-gray-300 leading-relaxed">
            {language === "fr"
              ? "Devenir la plateforme de référence pour l'entrepreneuriat digital en Afrique, en aidant 10 000 créateurs à générer plus de 100 millions de dollars de revenus collectifs."
